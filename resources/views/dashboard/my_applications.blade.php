            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{Storage::url($application->job->thumbnail)}}" alt="{{$application->job->thumbnail}}" class="rounded-2xl object-cover w-[120px] h-[90px]">
                    ...
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="{{route('dashboard.my.applications.details', $application)}}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            View Details
                        </a>
                    </div>
                </div>
