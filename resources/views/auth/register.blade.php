                ...
                <div class="p-8 sm:p-12">
                    ...
                    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <a href="{{ route('front.index') }}" class="block text-center">
                            <img src="{{ asset('assets/logos/intern.png') }}" class="h-20 mx-auto" alt="Logo InternPortal">
                        </a>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <label
                                            class="flex items-center justify-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition duration-300">
                                            <input type="radio" name="account_type" value="employee"
                                                class="mr-2 text-indigo-600 focus:ring-indigo-500">
                                            <span class="text-sm">Sebagai Karyawan</span>
                                        </label>
                                        <label
                                            class="flex items-center justify-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition duration-300">
                                            <input type="radio" name="account_type" value="employer"
                                                class="mr-2 text-indigo-600 focus:ring-indigo-500">
                                            <span class="text-sm">Sebagai Perusahaan</span>
                                        </label>
                                    </div>
                                </div>
